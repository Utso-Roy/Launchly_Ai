...
const Products_Details_Page = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axios.get(
        "https://launchlyserverside.vercel.app/all_products",
      );
  ...
  const handleReportConfirm = async () => {
    try {
      await axios.post("https://launchlyserverside.vercel.app/reported", {
  ...
  const handleReviewSubmit = async (e) => {
    ...
    try {
      await axios.post("https://launchlyserverside.vercel.app/reviews", {
