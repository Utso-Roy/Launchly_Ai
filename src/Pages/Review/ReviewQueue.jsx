...
const ReviewQueue = () => {
  ...
  useEffect(() => {
    fetch(`https://launchlyserverside.vercel.app/all_pending_products`)
      .then((res) => {
        if (!res.ok) {
  ...
  const updateProductStatus = async (id, status, successMessage) => {
    try {
      const res = await fetch(
        `https://launchlyserverside.vercel.app/products/${id}/status`,
        {
          method: "PATCH",
          headers: {
  ...
  const handleFeatured = async (id) => {
    try {
      const res = await fetch(
        `https://launchlyserverside.vercel.app/products/${id}/feature`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
