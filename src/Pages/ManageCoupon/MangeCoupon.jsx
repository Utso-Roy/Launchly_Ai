...
const MangeCoupon = () => {
  ...
  const fetchCoupons = async () => {
    try {
      const res = await axios.get(
        "https://launchlyserverside.vercel.app/coupons",
      );
      setCoupons(res.data);
    } catch (err) {
    ...
    try {
      if (editingId) {
        const res = await axios.put(
          `https://launchlyserverside.vercel.app/coupons/${editingId}`,
          formData,
        );
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://launchlyserverside.vercel.app/coupons/${id}`);
