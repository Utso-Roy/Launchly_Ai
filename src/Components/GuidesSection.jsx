    ...
    <div className="py-12 ">
      ...
      <Container>
        ...
        {guides.map((guide, idx) => (
          <div
            key={idx}
            className="p-6 rounded-2xl shadow-lg bg-white dark:bg-gray-800 hover:shadow-xl transition-shadow  cursor-target cursor-pointer"
      ...
      <div className="mt-8 text-center"  data-aos-delay={400}>
        <Link to="/guide">
